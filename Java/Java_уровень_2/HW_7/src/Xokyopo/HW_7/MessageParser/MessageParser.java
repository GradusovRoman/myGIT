...
public class MessageParser {
    ...
    public static void main(String[] args) {
        ...
        String msg1 = "<LOGINTAG>логин</LOGINTAG><PASSWORDTAG>пароль</PASSWORDTAG>";
        Map<Tag,String> map = messageParser.parseStringByTags(msg1);
        System.out.println(map.values());
        System.out.println(messageParser.buildStringByMap(map));
    }
